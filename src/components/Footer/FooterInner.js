          ...
          <div className="contact-area d-flex flex-column justify-content-between">
            ...
            <div className="contact-info">
              <span className="contact contact-phone">
                <FaPhoneAlt className="contact-icon" /> Tel: +90 555 555 55 55
              </span>
              <span className="contact contact-email">
                <GrMail className="contact-icon" /> Email: berkmguler@gmail.com
              </span>
              <span className="contact contact-location">
                <MdLocationPin className="contact-icon" /> Address: Netherland /
                The Hague
              </span>
            </div>
